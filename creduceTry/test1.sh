...
TMP0='./tmp.txt'
TMP1='./tmp.txt'
gcc -Wstrict-prototypes -Wfatal-errors -pedantic -Wall -fsanitize=undefined -Wsystem-headers -O3 -I${CSMITH_HOME}/runtime ./initial.c -o ./tmp.out 2> /dev/null

(ulimit -t 5; ./tmp.out > /dev/null)
if ! test "$?" = "0"; then
    exit 1
fi 
